...
return [
    ...
    'attributes' => [
        ...
        'description.en' => 'الوصف',
        'name.ar' => 'الاسم',
        'name.en' => 'الاسم',
        'name' => 'الاسم',
        'message' => 'الرسالة',
        'pages.*.hyper_link' => 'الرابط التشعبي',
        'pages.*.title.ar' => 'عنوان الصفحة',
        'pages.*.title.en' => 'عنوان الصفحة',
        'pages.*.description.ar' => 'وصف الصفحة',
        'pages.*.description.en' => 'وصف الصفحة',
        'pages.*.keywords' => 'الكلمات الدلالية',
        'meals_content' => 'محتوى الوجبة',
        'price' => 'السعر',
        'category_id' => 'القسم',
        'is_active' => 'الحالة',
